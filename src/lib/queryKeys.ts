export const queryKeys = {
  ...
  quotationRequests: (leadId: string) => ["quotation-requests", leadId] as const,
  quotations: (requestId: string) => ["quotations", requestId] as const,
  allQuotationRequests: () => ["all-quotation-requests"] as const,
  executionUsers: () => ["execution-users"] as const,
  clientTransactions: (leadId: string) => ["client-transactions", leadId] as const,
  costCategories: (leadId: string) => ["cost-categories", leadId] as const,
  vendorTransactions: (leadId: string) => ["vendor-transactions", leadId] as const,
  allClientTransactions: (from: string, to: string) => ["all-client-transactions", from, to] as const,
  allVendorTransactions: (from: string, to: string) => ["all-vendor-transactions", from, to] as const,
  itineraries: (leadId: string) => ["itineraries", leadId] as const,
  allItineraryLeads: () => ["itinerary-leads"] as const,
};
